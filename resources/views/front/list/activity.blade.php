            ...
            <div class="row multi-row-clearfix">
                <div class="blog-posts">
                                    ...
                                    <article class="post clearfix mb-30 bg-lighter">
                                        <div class="entry-header">
                                            <div class="post-thumb thumb">
                                                <img src="{{asset('uploads/activities/540x370/'.$activity->image_url)}}" alt="" class="img-responsive img-fullwidth">
                                            </div>
                                        </div>
                                        <div class="entry-content p-20 pr-10">
                                            ...
                                            <a href="{{route('activities.details',$description->slug)}}" class="btn-read-more">Read more</a>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="text-center">
                            <strong>Page : {{ $activities->currentPage() }} of {{ $activities->lastPage() }}</strong>
                        </div>
                    </div>
                </div>
            </div>
